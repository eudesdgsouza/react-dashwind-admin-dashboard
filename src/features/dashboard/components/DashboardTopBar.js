    ...
    return(
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="text-right ">
                <button className="btn btn-ghost btn-sm normal-case"><ArrowPathIcon className="w-4 mr-2"/>Atualizar</button>
                <button className="btn btn-ghost btn-sm normal-case  ml-2"><ShareIcon className="w-4 mr-2"/>Compartilhar</button>
                ...
                <div className="dropdown dropdown-bottom dropdown-end  ml-2">
                    ...
                    <ul tabIndex={0} className="dropdown-content menu menu-compact  p-2 shadow bg-base-100 rounded-box w-52">
                        <li><a><EnvelopeIcon className="w-4"/>Resumos por e-mail</a></li>
