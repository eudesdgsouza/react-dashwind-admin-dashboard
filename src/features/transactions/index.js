...
const TopSideButtons = ({removeFilter, applyFilter, applySearch}) => {
    ...
    const locationFilters = ["Paris", "Londres", "Canada", "Peru", "Tokyo"]
...
function Transactions(){
    ...
    return(
        <>
            ...
            <TitleCard title="Transaçaão Recente" topMargin="mt-2" TopSideButtons={<TopSideButtons applySearch={applySearch} applyFilter={applyFilter} removeFilter={removeFilter}/>}>
