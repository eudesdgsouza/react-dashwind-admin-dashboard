    ...
    return(
        <>
            <article className="prose">
              <h1 className="" >Componentes</h1>

              Adicionamos alguns componentes globais que são comumente usados ​​dentro do projeto.

                {/* Typography*/}
              <h2 id="component1">Tipografia</h2>
                <div>
                Esses componentes estão presentes em <span className="badge mt-0 mb-0 badge-ghost">/componentes/Tipografia</span> folder. It accepts styleClass as props which can be used to pass additional className for style. It has following components which you can import and use it - 
